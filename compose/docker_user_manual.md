# Document Converter - Docker User Manual

---

## 1. Overview

The **Document Converter** game can be distributed as a containerized application using **Docker**.
...
│
├── doco.Dockerfile          # Main application image (all OS)
├── doco.server.Dockerfile   # Base/server image (all OS)
│
...
**Purpose:**
Starts Document Converter game.
...
* Stops containers
* Removes containers
* Removes all Document Converter game images
...
**Purpose:**
Completely removes Document Converter game from Docker.
...
* Deletes containers
* Deletes images
* Leaves no Document Converter game artifacts behind
